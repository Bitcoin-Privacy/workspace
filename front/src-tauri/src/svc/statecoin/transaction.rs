use super::{client_config::ClientConfig, utils::info_config};
use anyhow::Result;
...
pub async fn new_transaction(
    ...
    let coin_nonce = statechain_core::transaction::create_and_commit_nonces(&coin)?;
    ...
    // NOTE: Request signature from C++
    // Using its keypair to sign the message
...
pub async fn sign_first(
    ...
    let sign_first_response_payload: statechain_core::transaction::SignFirstResponsePayload =
