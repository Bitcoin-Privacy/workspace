...
export const CoinjoinCard: FC<ICoinjoinCard> = (props) => {
  ...
  return (
    ...
    >
      <Box>
        <Text fontSize="16px" fontWeight="700" w="100%" color="#eef">
          Room {data.id.slice(undefined, 8)}
        </Text>
        <Text>
          Base amount: <b>{data.base_amount} sats</b>
        </Text>
        <Text>Peers: {data.no_peer}</Text>
        {/* <UnorderedList w="100%"> */}
        {/*   <ListItem>Amount: {data.base_amount} sats</ListItem> */}
        {/*   <ListItem>Peers: {data.no_peer}</ListItem> */}
